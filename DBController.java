...
public class DBController extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_CARDHOLDER + " (CARD_pID INTEGER PRIMARY KEY AUTOINCREMENT, REGISTRATION_pID INTEGER NOT NULL, CARD_NAME TEXT NOT NULL, CARD_NUMBER INTEGER NOT NULL, CARD_EXPIRATION TEXT NOT NULL, CARD_CVV INTEGER NOT NULL, CARD_ADDRESS TEXT NOT NULL, CARD_ZIPCODE INTEGER NOT NULL, CARD_CITY TEXT NOT NULL, CARD_STATE TEXT NOT NULL, CARD_COUNTRY TEXT NOT NULL, FOREIGN KEY(REGISTRATION_pID) REFERENCES Registration(REGISTRATION_pID))");
        db.execSQL("create table " + TABLE_MENU_DISH + "(DISH_pID INTEGER PRIMARY KEY AUTOINCREMENT, DISH_NAME TEXT NOT NULL, DISH_PRICE DOUBLE NOT NULL, DISH_QUANTITY INTEGER NOT NULL, FOREIGN KEY (CUSTOMER_NAME) REFERENCES TABLE_REGISTRATIONS (REGISTRATIONS_USER))");
        db.execSQL("create table " + TABLE_MENU_APPETIZER + "(APPETIZER_pID INTEGER PRIMARY KEY AUTOINCREMENT, APPETIZER_NAME TEXT NOT NULL, APPETIZER_PRICE DOUBLE NOT NULL, APPETIZER_QUANTITY INTEGER NOT NULL, FOREIGN KEY (CUSTOMER_NAME) REFERENCES TABLE_REGISTRATIONS (REGISTRATIONS_USER))");
        db.execSQL("create table " + TABLE_MENU_DRINKS + "(DRINKS_pID INTEGER PRIMARY KEY AUTOINCREMENT, DRINKS_NAME TEXT NOT NULL, DRINKS_PRICE DOUBLE NOT NULL, DRINKS_QUANTITY INTEGER NOT NULL, FOREIGN KEY (CUSTOMER_NAME) REFERENCES TABLE_REGISTRATIONS (REGISTRATIONS_USER))");
        db.execSQL("create table " + TABLE_MENU_DESSERTS + "(DESSERTS_pID INTEGER PRIMARY KEY AUTOINCREMENT, DESSERTS_NAME TEXT NOT NULL, DESSERTS_PRICE DOUBLE NOT NULL, DESSERTS_QUANTITY INTEGER NOT NULL, FOREIGN KEY (CUSTOMER_NAME) REFERENCES TABLE_REGISTRATIONS (REGISTRATIONS_USER))");
    }
